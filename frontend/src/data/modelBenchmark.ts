...
export const benchmarkModels: BenchmarkModelConfig[] = [
  ...
  { id: 'ollama-deepseek-r1-15b', name: 'deepseek-r1:1.5b', providerId: 'ollama-local', family: 'SLM', hosting: 'Local', version: '1.5b-reasoning', contextWindow: 131072, maxOutputTokens: 1024, supportsConfidence: false, supportsMemoryMetrics: true, inputCostPer1k: 0, outputCostPer1k: 0, capability: { reasoning: 82, speed: 58, cost: 100, grounding: 74, operations: 77 } },
  ...
  { id: 'ollama-phi35-38b', name: 'phi3.5:3.8b', providerId: 'ollama-local', family: 'SLM', hosting: 'Local', version: '3.8b-mini-instruct', contextWindow: 131072, maxOutputTokens: 1024, supportsConfidence: false, supportsMemoryMetrics: true, inputCostPer1k: 0, outputCostPer1k: 0, capability: { reasoning: 78, speed: 64, cost: 100, grounding: 73, operations: 84 } },
  { id: 'ollama-phi4-mini', name: 'phi4-mini', providerId: 'ollama-local', family: 'SLM', hosting: 'Local', version: '3.8b-tool-ready', contextWindow: 131072, maxOutputTokens: 1024, supportsConfidence: false, supportsMemoryMetrics: true, inputCostPer1k: 0, outputCostPer1k: 0, capability: { reasoning: 81, speed: 62, cost: 100, grounding: 76, operations: 86 } },
];
